...
const Features = () => {
  return (
    <div
      className={`${poppins.className} bg-blue-700 text-white w-full h-auto p-6 `}
    >
      <div className="flex flex-col items-center justify-center mx-auto ">
        <h1
          className="text-3xl text-center font-bold md:text-5xl lg:text-left animate-fade-in transition-all duration-500 ease-in-out
        transform hover:translate-y-[-5px] hover:text-slate-400 text-white "
        >
          Welcome to Saleha&apos;s Tech Tune{" "}
        </h1>
        <p className="text-center m-4 mt-4 text-sm text-slate-300 sm:text-base md:mb-12 1g:mb-16 animate-fade-in-up delay-300 ">
          Your Ultimate IT Solution. Transform your business with our
          cutting-edge technology solutions, expert consulting services, and
          innovative approach. From cloud computing and cybersecurity to data
          analytics and software development, we&aposve got you covered.
        </p>
      </div>
...
my-8 text-slate-300 "
      ...
      <p className="text-sm md:text-base ☐ text-slate-300 mb-6 px-4 animate-fade-in-down delay-100 mt-10">
        Dive into our diverse range of categories, where you&apos;ll discover a
        wealth of knowledge and insights tailored to your interests. Each
